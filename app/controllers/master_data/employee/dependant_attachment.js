...
const bank = db.bank;
const dependant_attachment=db.bank_details
...
exports.addDependantAttachment = (req, res) => {
 ...
 exports.editDependantAttachment = (req, res) => {
     const id = req.body.id;
     const bank_id = req.body.bank_id;
     const employee = req.body.employee_id;
     const account_no = req.body.account_number;
     const card = req.body.card_copy;
     dependant_attachment.findOne({
         where: {
             id: id
         }
     }).then((data) => {
 ...
 exports.findAllDependantAttachment = (req, res) => {
     dependant_attachment.findAll({
 ...
 exports.activateDependantAttachment = (req, res) => {
     const id = req.body.id;
 ...
 exports.deactivateDependantAttachment = (req, res) => {
     const id = req.body.id;
