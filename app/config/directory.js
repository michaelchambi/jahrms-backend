        ...
        moduleData() {
            app_module.create({
                ...
                app_module_permissions.create({
                    ...
                    module_id: data.id,
                    role_id: 1
                }).then((module_permission_results) => {
                    // ================================================================
            ...
            app_module_permissions.create({
                ...
                app_submodule.create({
                    ...
                    app_sub_module_permissions.create({
                        ...
                        app_action.create({
                            uid: uuid.v4(),
                            name: "view-employee-detail-list",
                            active: true,
                            module_id: data.id,
                            sub_module_id: submodule.id
                        }).then((action) => {
                        ...
                        app_action.create({
                            uid: uuid.v4(),
                            name: "deactivate-employee-detail",
                            active: true,
                            module_id: data.id,
                            sub_module_id: submodule.id
                        }).then((action) => {
                        ...
                        app_action.create({
                            uid: uuid.v4(),
                            name: "view-employee-detail-actions-list",
                            active: true,
                            module_id: data.id,
                            sub_module_id: submodule.id
                        }).then((action) => {
                        ...
                        app_action.create({
                            uid: uuid.v4(),
                            name: "add-employee-detail-actions",
                            active: true,
                            module_id: data.id,
                            sub_module_id: submodule.id
                        }).then((action) => {
                        ...
                        app_action.create({
                            uid: uuid.v4(),
                            name: "edit-employee-detail-actions",
                            active: true,
                            module_id: data.id,
                            sub_module_id: submodule.id
                        }).then((action) => {
                        ...
                        app_action.create({
                            uid: uuid.v4(),
                            name: "activate-employee-detail-actions",
                            active: true,
                            module_id: data.id,
                            sub_module_id: submodule.id
                        }).then((action) => {
                        ...
                        app_action.create({
                            uid: uuid.v4(),
                            name: "deactivate-employee-detail-actions",
                            active: true,
                            module_id: data.id,
                            sub_module_id: submodule.id
                        }).then((action) => {
